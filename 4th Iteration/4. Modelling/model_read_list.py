...
parameters = "../../../Data/parameters2.txt"  # Parameters file
...
if __name__ == "__main__":  # Run program
    ...
    if d["ElasticNet"][0] == "y":
        classifier = ElasticNet(alpha=float(d["ElasticNet"][1]), l1_ratio=float(d["ElasticNet"][2]), max_iter=int(d["ElasticNet"][3]))
