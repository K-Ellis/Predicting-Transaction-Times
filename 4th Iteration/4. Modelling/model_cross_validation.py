...
Proposed cross validation model program
6/7/17
*******************************************************************************
Eoin Carroll
Kieron Ellis
...
Parameters file (classifiers changed to match sklearn format + CV param):
LinearRegression: y
ElasticNet: y
KernelRidge: n
...
Saving plots and text files now only save time
...
def results(df, alg, classifier, newpath, d, importances=None):
