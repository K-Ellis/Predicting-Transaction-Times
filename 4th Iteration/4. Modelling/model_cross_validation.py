...
*******************************************************************************
Iteration 4
Data modelling program - cross validation testing
6/7/17
*******************************************************************************
Eoin Carroll
Kieron Ellis
...
def linear_regression(df, trainData_x, trainData_y, testData_x, testData_y, newpath, d):
...
def elastic_net(df, trainData_x, trainData_y, testData_x, testData_y, newpath, d):  # Elastic Net
...
def kernel_ridge(df, trainData_x, trainData_y, testData_x, testData_y, newpath, d):  # Kernel ridge regression
...
def Random_Forest_Regressor(df, trainData_x, trainData_y, testData_x, testData_y, newpath, d):  # Kernel ridge regression
...
if __name__ == "__main__":  # Run program
    ...
    if d["linear_regression"] == "y":
        linear_regression(df, trainData_x, trainData_y, testData_x, testData_y, newpath, d)  # Linear Regression
    if d["elastic_net"] == "y":
        elastic_net(df, trainData_x, trainData_y, testData_x, testData_y, newpath, d)  # elastic net
    if d["kernel_ridge"] == "y":
        kernel_ridge(df, trainData_x, trainData_y, testData_x, testData_y, newpath, d)  # Kernel ridge regression
    if d["random_forest_regressor"] == "y":
        Random_Forest_Regressor(df, trainData_x, trainData_y, testData_x, testData_y, newpath, d)  # Random Forest
        ...
        if d["linear_regression"] == "y":
            linear_regression(df2, trainData_x, trainData_y, testData_x, testData_y, newpath, d)  # Linear Regression
        if d["elastic_net"] == "y":
            elastic_net(df2, trainData_x, trainData_y, testData_x, testData_y, newpath, d)  # elastic net
        if d["kernel_ridge"] == "y":
            kernel_ridge(df2, trainData_x, trainData_y, testData_x, testData_y, newpath, d)  # Kernel ridge regression
        if d["random_forest_regressor"] == "y":
            Random_Forest_Regressor(df2, trainData_x, trainData_y, testData_x, testData_y, newpath, d)  # Random Forest
